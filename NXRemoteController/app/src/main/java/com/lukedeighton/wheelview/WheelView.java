...
public class WheelView extends View {
    ...
    private static final float ANGULAR_VEL_COEFFICIENT = 1f; // 22f;
    ...
    /**
     * <p> When true the wheel mDrawable is rotated as well as the wheel items.
     * For performance it is better to not rotate the wheel mDrawable if possible.
    ...
    /**
     * @return {@code true} if the wheel mDrawable rotates.
     */
    ...
    /**
     * You should set the wheel mDrawable not to rotate for a performance benefit.
    ...
    /**
     * Sets the wheel's mDrawable that can also rotate with the items.
     *
     ...
     * </p>
     * <p>
     * Note if the mDrawable has infinite lines of symmetry then you should set the wheel mDrawable to
     * not rotate, see {@link #setWheelDrawableRotatable(boolean)}. In other words, if the mDrawable
     * doesn't look any different whilst it is rotating, you should improve the performance by
     * disabling the mDrawable from rotating.
     * </p>
     *
     * @see #setWheelDrawableRotatable(boolean)
     */
    ...
    /**
     * Sets the empty item mDrawable that is drawn when outside of the adapter range.
     *
    ...
    /**
     * Sets the selection mDrawable to be a circular color
     *
    ...
    /**
     * Sets the selection mDrawable from a Drawable Resource.
     *
    ...
    /**
     * Set the selection mDrawable that is drawn behind the selected item.
     *
     * @see #setSelectionDrawable(int)
     * @see #setSelectionColor(int)
     */
    ...
    /**
     * @return the empty item mDrawable used when rendering positions outside of the adapter range.
     *
     * @see #isEmptyItemPosition(int)
     */
    ...
    /**
     * Invalidate the mDrawable at the specific position so that the next Draw call
    ...
    /**
     * The ItemState is used to provide extra information when transforming the selection mDrawable
     * or item bounds.
     */
